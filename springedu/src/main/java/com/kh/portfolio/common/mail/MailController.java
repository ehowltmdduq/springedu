...
public class MailController {
	...
	public void sendMail(HttpServletRequest request, HttpServletResponse response) throws Exception{
		...
		sb.append("<a href='http://localhost:9080/portfolio/loginForm?id=ehowltmdduq@naver.com'>로그인</a>");
		sb.append("</body></html>");

//		mailService.sendMail(to, "신규 비밀번호 발송", sb.toString());
		mailService.sendMail("ehowltmdduq@naver.com", "신규 비밀번호 발송", sb.toString());
